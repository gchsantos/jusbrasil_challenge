    ...
    instances_urls = [
        {
            ...
            "show_url": "https://esaj.tjce.jus.br/cpopg/show.do?processo.numero=",
        },
        {
            "instance": 2,
            "url": "https://esaj.tjce.jus.br/cposg5/search.do?cbPesquisa=NUMPROC&tipoNuProcesso=UNIFICADO&dePesquisaNuUnificado=",
            "show_url": "https://esaj.tjce.jus.br/cposg5/show.do?processo.codigo=",
        },
    ]
...
def capture_task(self, cnj: str, batch_line_id: str, uid: str):
    ...
    status, lawsuit_datas = RobotCE().capture_pipeline(cnj)
